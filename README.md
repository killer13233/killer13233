...
# 👋 Hola, soy Martín Palacios

### 🎓 Estudiante de Ingeniería en Software · 4to Semestre · Universidad Técnica de Ambato

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2E97F7&center=true&vCenter=true&width=435&lines=Desarrollador+en+formación+%F0%9F%9A%80;Java+%7C+JavaScript+%7C+SQL;Apasionado+por+el+código+limpio+✨;UTA+%7C+Ambato%2C+Ecuador+🇪🇨)](https://git.io/typing-svg)
...
Soy estudiante de **Ingeniería en Software** en la **Universidad Técnica de Ambato (UTA)**, cursando el **4to semestre**. Me apasiona construir soluciones tecnológicas limpias, eficientes y escalables. Siempre en busca de aprender nuevas tecnologías y buenas prácticas de desarrollo.

- 📍 **Ubicación:** Ambato, Ecuador 🇪🇨
- 🎓 **Universidad:** Universidad Técnica de Ambato (UTA)
- 📚 **Semestre actual:** 4to Semestre — Ingeniería en Software
- 💡 **Intereses:** Desarrollo Backend, Bases de Datos, Algoritmos
- 🌱 **Actualmente aprendiendo:** Patrones de diseño, Spring Boot, APIs REST
- 🎯 **Meta:** Convertirme en un desarrollador full-stack sólido
...
```
🏛️  Universidad Técnica de Ambato (UTA)
📖  Ingeniería en Software
📅  2023 - Presente
📍  Ambato, Tungurahua, Ecuador
📊  Semestre actual: 4to Semestre
```
